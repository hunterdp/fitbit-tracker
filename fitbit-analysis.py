...
if __name__ == '__main__':
    ...
    for fname in file_list:
        ...
        if df.empty:
            ...
            # TODO(dph): Replace the printing of the file name with a progress bar.
            msg = 'Merging ' + fname
            print(msg)
    ...
    logging.warning('Number of empty files not merged:' + str(len(empty_file_list)))
    for i in empty_file_list:
        logging.debug('Empty file, not merged: ' + i)

    logging.warning('Number of files with all zeros:' + str(len(all_zeros_file_list)))
